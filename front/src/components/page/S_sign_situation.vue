    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="access_goal" label="获得分数" width="120">
                </el-table-column>
                <el-table-column prop="total_goal" label="总分数" width="120">
                </el-table-column>
                ...
                self.$http({
                    ...
                    params:{
                        ...
                        for(let i in response.body){
                            ...
                            this.tableData[i].access_goal=response.data[i].acc_goals;
                            this.tableData[i].total_goal=response.data[i].total;
                        }
                    });
