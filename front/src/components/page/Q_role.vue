        ...
        <div class="container">
            <div class="handle-box">
                <el-form :model="selectForm"  ref="selectForm">
                    ...
                    <el-select v-model="selectForm.selectSchool" placeholder="全部身份" class="handle-select mr10">
        ...
        <el-dialog :title="this.isAdd?'新增':'编辑'" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="50px">
                <el-form-item label="学/工号">
                    <el-input type="course" v-model="form.number"></el-input>
                </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            search(formName) {
                this.isSearch = true;
                const self = this;
                console.log(this.selectForm.selectSchool);
                self.$http({
                    method:'get',
                    url:'/api/user/q_role_select',
                    params:{
