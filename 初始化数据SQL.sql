...
CREATE TABLE `class` (
  ...
  `Class_Place` varchar(32) DEFAULT NULL,
...
CREATE TABLE `course` (
  ...
  `Course_Require` varchar(255) DEFAULT NULL,
  `Course_proceed` varchar(255) DEFAULT NULL,
  `Course_Exam` varchar(255) DEFAULT NULL,
  `Createby` varchar(16) DEFAULT NULL,
...
CREATE TABLE `joinclass` (
  ...
  CONSTRAINT `ClassNo_fk` FOREIGN KEY (`Class_No`) REFERENCES `class` (`Class_No`),
  CONSTRAINT `telphone_fk` FOREIGN KEY (`telphone`) REFERENCES `user` (`User_Telephone`)
...
CREATE TABLE `user` (
  ...
  `User_Institute` varchar(32) DEFAULT NULL,
  `Createby` varchar(16) DEFAULT NULL,
  `Createdate` datetime DEFAULT CURRENT_TIMESTAMP,
  `Modifyby` varchar(16) DEFAULT NULL,
  `Modifydate` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'wood', 'student', '180327068', '17805949770', 'aA123456', '男', '1997.12', '福州大学', '数学与计算机科学学院', null, '2019-05-22 09:34:39', null, '2019-07-04 14:23:43');
INSERT INTO `user` VALUES ('2', '郑小明', 'teacher', '180356459', '17805949771', 'sS111111', '男', '1995.1', '福州大学', '数学与计算机科学学院', null, '2019-05-22 09:36:47', null, '2019-07-04 14:23:45');
INSERT INTO `user` VALUES ('3', '池之标', 'teacher', '180366251', '18659947856', 'bB111111', '男', '1985.12', '福州大学', '数学与计算机科学学院', null, '2019-05-29 16:33:35', null, '2019-07-04 14:23:46');
INSERT INTO `user` VALUES ('4', '郑沐', 'student', '180327091', '15659100305', 'aA123456789', '男', '1997.2', '福建师范大学', '数学与计算机科学学院', null, '2019-05-31 21:24:01', null, '2019-07-04 14:23:47');
