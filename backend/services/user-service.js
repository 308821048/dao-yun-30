...
const getError = require('../utils').getErrObj
const Util = require('../utils')
const User = require('../models/UserModel')
const LogUtil = require('../log-util')
const Manager = require('../models/ManagerModel')

const config = require('../config-override')
...
const MailSender = nodemailer.createTransport({
    ...
    auth: {
        user: "782799011@qq.com",
        pass: "aouufqzoxnbtbaig"
    }
});
...
var sendEmailCode = async (email) => {
    ...
    let sendOption = {
        from: '<782799011@qq.com>', // sender address
        to: email, // list of receivers
        subject: "\"早早\"APP注册验证码", // Subject line
